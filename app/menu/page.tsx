    ...
    <div className="min-h-screen bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/FInal%20background-1QBTDWqBZCuDtvk4nL5549cN20arkv.jpeg')"}}>
      <div className="min-h-screen bg-black bg-opacity-50 flex flex-col">
        ...
        <main className="flex-grow container mx-auto px-4 py-8 text-white">
          <h1 className="text-4xl font-serif text-yellow-400 text-center mb-8">Our Menu</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <section key={index} className={`bg-black bg-opacity-75 p-6 rounded-lg ${
                ...
                <h2 className="text-2xl font-serif text-yellow-400 mb-4">{section.title}</h2>
                <ul className="space-y-2 max-h-[calc(100%-2rem)] overflow-y-auto pr-2">
